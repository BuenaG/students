...
public class Info {
	...
	public Info(String id_etudiant, String groupe, String nom, String prenom, String nom_cours, String points) {
		super();
	...
	{
		return id_etudiant+" "+groupe+" "+nom+" "+prenom+" "+nom_cours+" "+points;
	}
